-- ==============================================================================
-- KOZA BISNIS — SECURITY HARDENING & MIDTRANS DATABASE PATCH (2026-09-11)
-- 
-- 1. Buat tabel topup_transactions (jika belum ada) beserta RLS-nya
-- 2. Buat fungsi settlement Midtrans dengan hak eksekusi HANYA untuk service_role
-- 3. Kunci kolom kritis (quota_balance, plan, plan_expiry_date) pada tabel stores
-- ==============================================================================
...
-- ------------------------------------------------------------------------------
-- 2. FUNGSI ATOMIK MIDTRANS SETTLEMENT (HANYA SERVICE_ROLE)
-- ------------------------------------------------------------------------------

-- Fungsi 2.1: Settlement Pembayaran Sukses
...
-- Fungsi 2.2: Pencatatan Transaksi Gagal / Expired
...
-- CABUT AKSES PUBLIK (ANON & AUTHENTICATED)
...
-- BERIKAN HAK HANYA KEPADA SERVICE_ROLE (BACKEND RESMI)
...
-- ------------------------------------------------------------------------------
-- 3. TRIGGER BEFORE UPDATE: PROTEKSI KOLOM KUOTA & PLAN PADA TABEL STORES
-- ------------------------------------------------------------------------------
...
AS $$
BEGIN
    -- Izinkan jika request datang dari service_role atau eksekusi internal postgres
